...
```bash
[afu@mattermost-211 ~]$ sudo mount -t ceph 10.1.13.231:6789:/ /mnt/cephfs
mount: wrong fs type, bad option, bad superblock on 10.1.13.231:6789:/,
       missing codepage or helper program, or other error

       In some cases useful info is found in syslog - try
       dmesg | tail or so.
[afu@mattermost-211 ~]$
[afu@mattermost-211 ~]$ sudo dmesg | tail
